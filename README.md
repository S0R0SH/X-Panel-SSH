...
```
bash <(curl -Ls https://raw.githubusercontent.com/amirmalakie/X-Panel-SSH-User-Management/master/fix-call.sh --ipv4)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/amirmalakie/X-Panel-SSH-User-Management/main/TCP-Tweaker --ipv4)
```
## فعال سازی SSL
```
bash <(curl -Ls https://raw.githubusercontent.com/amirmalakie/X-Panel-SSH-User-Management/main/ssl.sh --ipv4)
```
